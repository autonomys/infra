...
docker pull ghcr.io/subspace/bootstrap-node:gemini-3d-2023-may-23-aarch64
node_count=${1}
output_file=${2}
port=${3:-30333}
...
for (( i = 0; i < node_count; i++ )); do
    data="$(docker run --rm "ghcr.io/subspace/bootstrap-node:gemini-3d-2023-may-23-aarch64" generate-keypair 2>&1)"
