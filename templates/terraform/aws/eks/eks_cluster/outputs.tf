...
output "eks_platform_teams_configure_kubectl" {
  ...
  value       = "aws eks --region ${var.aws_region} update-kubeconfig --name ${module.eks.cluster_name}  --role-arn ${module.eks_platform_teams.iam_role_arn}"
}
...
output "eks_dev_teams_configure_kubectl" {
  ...
  value       = [for team in module.eks_dev_teams : "aws eks --region ${var.aws_region} update-kubeconfig --name ${module.eks.cluster_name}  --role-arn ${team.iam_role_arn}"]
}
