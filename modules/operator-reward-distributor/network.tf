...
resource "aws_subnet" "public_subnets" {
  ...
  tags = {
    Name = "${var.instance.network_name}-public-subnet-reward-distributor"
  }
}
...
resource "aws_internet_gateway" "gw" {
  ...
  tags = {
    Name = "${var.instance.network_name}-igw-public-subnet-reward-distributor"
  }
...
resource "aws_route_table" "public_route_table" {
  ...
  tags = {
    Name = "${var.instance.network_name}-public-route-tbl-reward-distributor"
  }
...
resource "aws_security_group" "network_sg" {
  name        = "${var.instance.network_name}-network-reward-distributor-sg"
  ...
  tags = {
    Name = "${var.instance.network_name}-reward-distributor-sg"
  }
