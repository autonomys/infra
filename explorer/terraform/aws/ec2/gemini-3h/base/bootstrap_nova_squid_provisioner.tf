...
resource "null_resource" "start-nova-blue-squid-nodes" {
  ...
  provisioner "remote-exec" {
    inline = [
      ...
      "echo NODE_NAME=SUBSQUID_GEMINI_3h >> /home/${var.ssh_user}/subspace/.env",
      ...
      "echo ARCHIVE_ENDPOINT=https://archive.gemini-3h.subspace.network/api >> /home/${var.ssh_user}/subspace/.env",
      "echo CHAIN_RPC_ENDPOINT=wss://rpc-0.gemini-3h.subspace.network/ws >> /home/${var.ssh_user}/subspace/.env",
